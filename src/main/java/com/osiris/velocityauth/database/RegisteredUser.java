    ...
    static {
        try {
            ...
            try (Statement s = con.createStatement()) {
                ...
                s.executeUpdate("ALTER TABLE `RegisteredUser` ADD COLUMN IF NOT EXISTS id INT NOT NULL PRIMARY KEY");
                s.executeUpdate("ALTER TABLE `RegisteredUser` MODIFY IF EXISTS id INT NOT NULL PRIMARY KEY");
                s.executeUpdate("ALTER TABLE `RegisteredUser` ADD COLUMN IF NOT EXISTS username TEXT NOT NULL");
